...
public class CensusAndStateCodeAnalyserTest {
    ...
    @Test
    public void givenCSVFile_WhenHeaderIncorrect_ShouldThrowException() {
        try {
            censusAndStateCodeAnalyser.loadCensusData(CensusAndStateCodeAnalyser.Country.INDIA, WRONG_INDIA_CENSUS_HEADER_FILE);
        } catch (CensusAndStateCodeAnalyserException e) {
            Assert.assertEquals(CensusAndStateCodeAnalyserException.ExceptionType.INCORRECT_DELIMITER_OR_HEADER_ISSUE, e.type);
        }
    }
    ...
    public void givenIndiaStateData_WithWrongFile_ShouldThrowException() {
        try {
            ExpectedException exceptionRule = ExpectedException.none();
            exceptionRule.expect(CensusAndStateCodeAnalyserException.class);
            censusAndStateCodeAnalyser.loadCensusData(CensusAndStateCodeAnalyser.Country.INDIA, WRONG_STATE_CODE_CSV_FILE_PATH);
        } catch (CensusAndStateCodeAnalyserException e) {
            Assert.assertEquals(CensusAndStateCodeAnalyserException.ExceptionType.FILE_PROBLEM, e.type);
        }
    }
    ...
    public void givenIndiaStateData_WithWrongType_ShouldThrowException() {
        try {
            censusAndStateCodeAnalyser.loadCensusData(CensusAndStateCodeAnalyser.Country.INDIA, WRONG_STATE_CODE_FILE_TYPE);
        } catch (CensusAndStateCodeAnalyserException e) {
            Assert.assertEquals(CensusAndStateCodeAnalyserException.ExceptionType.FILE_PROBLEM, e.type);
        }
    }
    ...
    @Test
    public void givenIndiaStateCSVFile_WhenDelimiterIncorrect_ShouldThrowException() {
        try {
            censusAndStateCodeAnalyser.loadCensusData(CensusAndStateCodeAnalyser.Country.INDIA, WRONG_STATE_CODE_DELIMITER_FILE);
        } catch (CensusAndStateCodeAnalyserException e) {
            Assert.assertEquals(CensusAndStateCodeAnalyserException.ExceptionType.INCORRECT_DELIMITER_OR_HEADER_ISSUE, e.type);
        }
    }
    ...
    @Test
    public void givenIndiaStateCSVFile_WhenHeaderIncorrect_ShouldThrowException() {
        try {
            censusAndStateCodeAnalyser.loadCensusData(CensusAndStateCodeAnalyser.Country.INDIA, WRONG_STATE_CODE_HEADER_FILE);
        } catch (CensusAndStateCodeAnalyserException e) {
            Assert.assertEquals(CensusAndStateCodeAnalyserException.ExceptionType.INCORRECT_DELIMITER_OR_HEADER_ISSUE, e.type);
        }
    }
    ...
    public void givenIndiaAndUSCensusData_WhenSortedOnPopulationDensity_ShouldReturnSortedResult() throws CensusAndStateCodeAnalyserException {
        ...
        String result=Double.parseDouble(censusCSV[0].densityPerSqKm) > Double.parseDouble(indiaCensusCSV[0].densityPerSqKm) ? "US" : "India";
