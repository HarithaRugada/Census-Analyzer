...
public class CensusAdapterFactory {
    public static Map<String, CensusDAO> getCensusAdapter(CensusAndStateCodeAnalyser.Country country, String... csvFilePath) throws CensusAndStateCodeAnalyserException {
